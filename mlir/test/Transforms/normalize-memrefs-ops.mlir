...
// For all these cases, we test if MemRefs Normalization works with the test operations
// * test.op_norm: this operation has the MemRefsNormalizable attribute. The tests 
//   that include this operation are constructed so that the normalization should happen.
// * test_op_nonnorm: this operation does not have the MemRefsNormalization attribute.
//   The tests that include this operation are contructed so that the normalization 
//   should not happen.
