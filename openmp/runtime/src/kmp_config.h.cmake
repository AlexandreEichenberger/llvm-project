...
// The platform test is belt and braces: CMake offers the option on these three
// only, but defining it by hand elsewhere must still reduce to the stub. z/OS is
// also in the first term, because there the runtime creates no threads at all
// and this is not an option but the only way it obtains a worker.
#define KMP_USE_DONATED_THREADS                                                \
  ((LIBOMP_USE_DONATED_THREADS || KMP_OS_ZOS) &&                               \
   (KMP_OS_LINUX || KMP_OS_DARWIN || KMP_OS_ZOS))
